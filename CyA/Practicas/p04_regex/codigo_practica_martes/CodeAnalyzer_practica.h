...
public:
    ...
    void WriteOutput(const std::string& inputFile, const std::string& outputFile, variableHandler& variables, loopsHandler& loops, commentHandler& comments, structHandler& structhandler);
...
private:
    ...
    void AnalyzeStructs(const std::string& line, const std::smatch& match, const int lineNumber, structHandler& structHandler); 
