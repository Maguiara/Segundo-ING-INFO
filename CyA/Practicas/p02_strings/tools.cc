...
void CheckHelp (char* argv[]) {
  ...
  if (user_help_string == "--help") {
    ...
    "Opcode: Numeros desde el 1 hasta el 5 en el que cada uno de estos representan una operacion distina a realizar sobre los datos incluidos en el fichero de entrada\n " <<
